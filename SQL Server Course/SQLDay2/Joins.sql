...
select
	...
	join sales.salesorderheader soh  with (nolock)
		on isnull(sod.SalesOrderID, 'XXXXXX') = soh.salesOrderID  -- INCASE THE FK COULD HAVE NULLS, USE THE isnull FUNCTION TO REPLACE with an unnatural string and you can use the equality sign
